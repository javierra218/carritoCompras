...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <a class="button-admin button-agregar" type="submit" href="?c=Carrito&a=CrearEditar&proid=<?php echo $producto->__get('id');?>&usuid=<?php echo isset($this->usuario) ? $this->usuario->__get('id') : " "; ?>">Agregar Carrito</a>
    </div>
    </article>
    <?php endforeach; ?>
    </div>
