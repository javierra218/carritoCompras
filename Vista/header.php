...
<body>
  <header class="header">
    <div class="logo" ><img src="Vista/css/logo3.png" alt="logo" height="80"></div>
      ...
      <div class="center-header">
        <nav class="navigation">
          <ul>
            ...
            <li>
            <a class="fa-solid fa-cart-shopping"  href="?c=Carrito&amp;a=Listar&amp;codUsu=4"></a> <!-- Para ver el carrito sin iniciar session o solo no-admin -->
            </li>
